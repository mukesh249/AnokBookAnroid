...
import com.anokbook.Activites.AddPost;
...
public class ImagePickerDemo extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (TedBottomPicker.selectedUriList.size()>0){
                    Intent intent = new Intent(ImagePickerDemo.this, AddPost.class);
                    intent.putParcelableArrayListExtra("AddPostselecetedImage",TedBottomPicker.selectedUriList);
                    Log.d("SelectedImage",TedBottomPicker.selectedUriList+"");
                    startActivity(intent);
                }else {
                    Toast.makeText(ImagePickerDemo.this, "Please select Images for post",
            ...
            getBackgroundHandler().post(new Runnable() {
                ...
                public void run() {
                    String timeStamp = new SimpleDateFormat("yyyyMMddHHmmss",
                            ...
                            new Date());
                    String imageFileName = "anok" + timeStamp + ".jpg";
                    File file = new File(getExternalFilesDir(Environment.getExternalStorageDirectory().getAbsolutePath()),imageFileName);
//                    File fileImage = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/media/drawim");

                    OutputStream os = null;
//                    Uri photoURI = Uri.parse(file.getPath());
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ImagePickerDemo.this, HomeScreen.class));
        finish();
    }
