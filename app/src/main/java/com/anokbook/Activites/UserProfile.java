...
public class UserProfile extends AppCompatActivity implements WebCompleteTask {
    ...
    @BindView(R.id.nestscroolview) NestedScrollView nestscroolview;
    @BindView(R.id.user_mobile_no) TextView user_mobile_no;
    @BindView(R.id.user_email) TextView user_email;
    @BindView(R.id.edit_profile_tv) TextView edit_profile_tv;
    ...
    @BindView(R.id.user_review_recyclerview) RecyclerView user_review_recyclerview;
