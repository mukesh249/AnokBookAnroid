...
public class HomeScreen extends AppCompatActivity implements WebCompleteTask {
    ...
    @BindView(R.id.current_dis) ImageView current_dis;
    @BindView(R.id.km_5) TextView km_5;
    @BindView(R.id.km_10) TextView km_10;
    @BindView(R.id.km_15) TextView km_15;
    @BindView(R.id.km_20) TextView km_20;
    @BindView(R.id.km_25) TextView km_25;
    @BindView(R.id.list_view_img) ImageView list_view_img;
    @BindView(R.id.grid_view_img) ImageView grid_view_img;
    @BindView(R.id.spinner_sorting) Spinner spinner;
    ...
    @BindView(R.id.setting_rel) RelativeLayout setting;
    @BindView(R.id.home_rel) RelativeLayout home;
    @BindView(R.id.profile_rel) RelativeLayout profile;
    @BindView(R.id.my_ads_rel) RelativeLayout about;
    @BindView(R.id.FloatingActionButtonAddEmp)
    FloatingActionButton floatingActionButtonAddEmp;

    @BindView(R.id.filter_icon) ImageView filter_icon;
    @BindView(R.id.search_icon) ImageView search_icon;
    @BindView(R.id.top_action_bar) RelativeLayout top_action_bar;
    @BindView(R.id.km_layout) RelativeLayout km_layout;
    @BindView(R.id.view_type) RelativeLayout view_type;
    @BindView(R.id.bottom_rel) RelativeLayout bottom_rel;
    @BindView(R.id.notification_icon) ImageView notification_icon;
    @BindView(R.id.prof_tv) TextView prof_tv;
    @BindView(R.id.myads_tv) TextView myads_tv;
    ...
    @BindView(R.id.empty_lin) LinearLayout empty_lin;
    @BindView(R.id.cur_rel) RelativeLayout cur_rel;
    @BindView(R.id.search_et) AutoCompleteTextView search_et;
    @BindView(R.id.clear_icon) ImageView clear_icon;
    @BindView(R.id.search_submit) ImageView search_submit;
    @BindView(R.id.search_lay) RelativeLayout search_lay;
    @BindView(R.id.all_cate) TextView all_cate;
