...
public class ReceivedDetail extends AppCompatActivity implements WebCompleteTask {
    ...
    @BindView(R.id.transaction_process_lin)
    LinearLayout transaction_process_lin;
    @BindView(R.id.contact_to_requester_lin)
    LinearLayout contact_to_requester_lin;
    @BindView(R.id.did_you_hand_lin)
    LinearLayout did_you_hand_lin;
    @BindView(R.id.transaction_process_rel)
    RelativeLayout transaction_process_rel;
    @BindView(R.id.card_tp)
    CardView card_tp;
    @BindView(R.id.card_request)
    CardView card_request;
    @BindView(R.id.did_you_hand_rel)
    RelativeLayout did_you_hand_rel;
    @BindView(R.id.transaction_process_sh)
    LinearLayout transaction_process_sh;
    @BindView(R.id.view_requester_detail_tv)
    TextView view_requester_detail_tv;
    @BindView(R.id.did_you_hand_lin_sh)
    LinearLayout did_you_hand_lin_sh;
    @BindView(R.id.profile_edit_toobar)
    Toolbar toolbar;
    @BindView(R.id.payment_status_tv)
    TextView payment_status_tv;
    @BindView(R.id.yes_tp)
    TextView yes_tp;
    @BindView(R.id.no_tp)
    TextView no_tp;
    @BindView(R.id.drop_icon_tp)
    ImageView drop_icon_tp;
    @BindView(R.id.yes_did_u)
    TextView yes_did_u;
    @BindView(R.id.no_did_u)
    TextView no_did_u;
