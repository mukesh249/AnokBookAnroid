...
public class Privacypolicy extends AppCompatActivity implements WebCompleteTask {
    ...
    private void PrivacyPolicyMethod() {
        try {
            ...
            new WebTask(Privacypolicy.this, WebUrls.BASE_URL, objectNew, Privacypolicy.this, RequestCode.CODE_Privacypolicy, 1);
        ...
        if (RequestCode.CODE_Privacypolicy == taskcode){
            ...
            try {
                ...
                if (jsonObject.optString("status").compareTo("success")==0){
                    ...
                    Toast.makeText(Privacypolicy.this,jsonObject.optString("message"),Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
