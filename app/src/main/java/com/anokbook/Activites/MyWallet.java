...
public class MyWallet extends AppCompatActivity implements WebCompleteTask {
    ...
    @BindView(R.id.recycerview_histroy_wallet) RecyclerView recyclerview_history_wallet;
    ...
    @BindView(R.id.wallet_amout_tv) TextView wallet_amout_tv;
    @BindView(R.id.add_money_wallet_tv) TextView add_money_wallet_tv;
    @BindView(R.id.send_money_on_bank_tv) TextView send_money_on_bank_tv;
