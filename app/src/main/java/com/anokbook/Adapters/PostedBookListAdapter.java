...
import com.anokbook.Fragments.Posted;
import com.anokbook.Models.UserBookListModel;
import com.anokbook.R;

public class PostedBookListAdapter extends RecyclerView.Adapter<PostedBookListAdapter.ViewHolder> {
    ...
    public PostedBookListAdapter(ArrayList<UserBookListModel> userBookListModelArrayList, Context context){
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        userBookListModel = userBookListModelArrayList.get(i);
