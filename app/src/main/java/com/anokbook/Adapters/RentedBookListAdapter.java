...
import com.anokbook.Fragments.Rented;
import com.anokbook.Models.UserBookListModel;
import com.anokbook.R;

public class RentedBookListAdapter extends RecyclerView.Adapter<RentedBookListAdapter.ViewHolder> {
    ...
    public RentedBookListAdapter(ArrayList<UserBookListModel> userBookListModelArrayList, Context context){
